...
class NewsAdapter : RecyclerView.Adapter<NewsHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewsHolder {
        val binding: NewsCardBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.news_card, parent, false)
    ...
    inner class NewsHolder(private val binding: NewsCardBinding) : RecyclerView.ViewHolder(binding.root) {
